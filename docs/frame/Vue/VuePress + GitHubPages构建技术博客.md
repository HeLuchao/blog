...
# 如果发布到 https://HeLuchao.github.io  USERNAME=你的用户名
#git push -f git@github.com:/HeLuchao/blog.git master:master

# 如果发布到 https://github.com/HeLuchao/blog  REPO=github上的项目
git push -f git@github.com:HeLuchao/blog.git master:gh-pages
